/**
 * Apply grade4_<word>.png assets to grade 4 lesson.
 * Usage: node scripts/apply-grade4-word.mjs simile alliteration ...
 */
...
if (words.length === 0) {
  console.error("Usage: node scripts/apply-grade4-word.mjs <word> [word2 ...]");
  process.exit(1);
}
...
assertGrade123WriteAllowed("apply-grade4-word");
