/**
 * Scaffold BATCH71–80 prompts from grade4-cards (words 701–800).
 * Usage: node scripts/scaffold-grade4-batch71-80.mjs
 */
...
const lines = [
  `/** Auto-scaffolded BATCH71–80 (cards 701–800) — sentence-aligned */`,
...
const out = join(__dirname, "grade4-batch71-80-prompts.mjs");
