/**
 * Apply one Grade 3 illustration from assets. Usage: node scripts/apply-grade3-word.mjs <word> [word2 ...]
 */
...
if (words.length === 0) {
  console.error("Usage: node scripts/apply-grade3-word.mjs <word> [word2 ...]");
  process.exit(1);
}
