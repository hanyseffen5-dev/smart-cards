/**
 * Applies batch 3 Daniel illustrations (50 new words) from assets/daniel_*.png
 * Usage: node scripts/apply-daniel-batch3.mjs
 */
...
console.log(`\nBatch 3 applied: ${updated}/50. Daniel lesson now has ${stats.rows[0].with_image} images.`);
await client.close();
