/**
 * Apply one Grade 1 illustration from assets. Usage: node scripts/apply-grade1-word.mjs <word> [word2 ...]
 */
...
if (words.length === 0) {
  console.error("Usage: node scripts/apply-grade1-word.mjs <word> [word2 ...]");
  process.exit(1);
}
...
assertGrade123WriteAllowed("apply-grade1-word");
