/**
 * Grade 2 lesson flashcard images — same cream 640×640 technique as Daniel.
 */
...
export const LESSON_TITLE = "grade 2";

export const ASSETS_DIR = process.env.GRADE2_ASSETS_DIR || DEFAULT_ASSETS_DIR;

export function assetFileName(word) {
  return `grade2_${word.replace(/\s+/g, "_")}.png`;
}
...
export function buildPrompt({ word, example, sceneHint = "" }) {
  ...
  const scene =
    hint ||
    `Clear friendly children's scene for the English word "${word}" suitable for grade 2 learners.`;
