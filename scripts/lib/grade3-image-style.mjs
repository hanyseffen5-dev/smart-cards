/**
 * Grade 3 lesson flashcard images — same cream 640×640 technique as Daniel.
 */
...
export const LESSON_TITLE = "grade 3";

export const ASSETS_DIR = process.env.GRADE3_ASSETS_DIR || DEFAULT_ASSETS_DIR;

export function assetFileName(word) {
  return `grade3_${word.replace(/\s+/g, "_")}.png`;
}
...
export function buildPrompt({ word, example, sceneHint = "" }) {
  ...
  const scene =
    hint ||
    `Clear friendly children's scene for the English word "${word}" suitable for grade 3 learners.`;
